...
const saveImageToCloudStorageFromUrl = async (url, folderName, fileName) => {
    ...
    return saveImageToCloudStorage(localPath, folderName, fileName);
};
...
const saveImageToCloudStorage = async (localPath, folderName, fileName) => {
